...
export default function BlogsPage() {
  return <main className="editorialPage">
    <nav className="nav innerNav" aria-label="Main navigation"><a className="brand" href="/"><Logo /><span><b>ENTREPOT</b><strong>ROYALS</strong></span></a><div className="navLinks"><a href="/">Home</a><TeamMenu /><a href="/gallery">Royal Moments</a><a href="/supporters">Supporters</a><a className="active" href="/blogs">Blogs</a></div><HeaderSocials /><a className="navCta" href="/contact">Contact us ↗</a></nav>
    <header className="editorialHero blogHero"><div className="editorialHeroCopy"><p className="eyebrow"><span /> STORIES FROM THE KINGDOM</p><h1>ROYAL<br /><em>BLOGS</em></h1><p>Match-day emotion, team stories and the moments that shape the Entrepot Royals journey.</p></div><LandingHeroMedia photo="/royal-moment-squad-backs-enhanced.png" alt="Entrepot Royals players displaying their names and jersey numbers" caption="STORIES BEHIND THE CREST" /></header>
