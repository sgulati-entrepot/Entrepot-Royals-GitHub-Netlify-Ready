  ...
  return (
    <main className="profilePage">
      <nav className="nav innerNav" aria-label="Main navigation">
        ...
        <div className="navLinks"><a href="/">Home</a><a className="active" href="/owners">Owners</a><TeamMenu /><a href="/fixtures">Fixtures</a><a href="/gallery">Royal Moments</a><a href="/supporters">Supporters</a></div>
